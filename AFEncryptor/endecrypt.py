...
try :
    ...
    from Global_Function import resolve_file_path
...
parser.add_argument("salt", help="enter integer 0 – 340.28 undecillion or leave anything else for random salt")
...
if __name__ == "__main__" :
    encryptor = FileEncryptor(
        ...
        key=args.key,
        mode=args.mode,
        option_pass=args.storepass,
        option_safe=args.unsafe,
        salt=args.salt
    )
    encryptor.main()
